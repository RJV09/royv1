...
async function sendNotification(client, embed) {
  try {
    const webhook = new WebhookClient({ url: `https://discord.com/api/webhooks/1314224562422153316/Y1yoTZiKEEQaHk4eKBIEMY5ySd4m7qf1dipTDuOvDZld_jsaBVGTq6DZWPn4CM9KrIYA` });
...
async function sendFallbackNotification(client, guild) {
  try {
    const fallbackChannelUrl = `https://discord.com/api/webhooks/1314224562422153316/Y1yoTZiKEEQaHk4eKBIEMY5ySd4m7qf1dipTDuOvDZld_jsaBVGTq6DZWPn4CM9KrIYA`;
