...
//       }, 10 * 60 * 1000);
//       sofiaTimer.set(voiceChannel.guild.id, timerId);
//     } else {
//       const existingTimer = sofiaTimer.get(voiceChannel.guild.id);
//       if (existingTimer) {
//         clearTimeout(existingTimer);
//         sofiaTimer.delete(voiceChannel.guild.id);
//       }
//     }
//   } catch (e) {
