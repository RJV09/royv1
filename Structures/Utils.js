...
module.exports = class BotUtils {
  ...
  async massDM(client) {
    try {
      ...
      const embedData = {
        ...
        title: "🎉 Sofia has been Updated to V3!",
        description: `We're excited to announce that Sofia has been updated to Version 3!\n\nThank you for being part of our journey!\nCurrently serving **${totalMembers.toLocaleString()}** users across all servers.`,
        fields: [
          {
            name: "🆕 What's New?",
            value:
          ...
          },
          {
            name: "🔗 Quick Links",
            value:
              "• [Click Here To Know More](https://discord.gg/hindustani)\n• [Vote for Sofia](https://discord.gg/hindustani)\n• [Invite Sofia](https://discord.com/oauth2/authorize?client_id=1242025878159097947&permissions=8&scope=bot%20applications.commands)",
          },
        ],
        color: 0xFF66CC,
        timestamp: new Date(),
        footer: {
          text: `You received this message because you\'re Sofia Music's fav user`,
          iconURL: client.user.displayAvatarURL({ dynamic: true }),
        },
      };
  ...
  async sofiaAutoplay(player, url) {
    try {
